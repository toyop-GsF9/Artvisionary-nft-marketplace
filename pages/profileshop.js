			...
			<div className="flex flex-row md:flex-col justify-center items-center h-[362px] mx-4 mt-8 md:mt-32">
				<div className="text-2xl flex-grow mb-4 md:mb-0 md:mr-4">
					<p className="md:text-xl leading-relaxed">
						好きな作品を♡するだけで<br />
						あなた好みのプレイリストをスライド再生できます。インテリアとして、モニターのスリープ機能として<br />
						アート作品をお楽しみください。<br />
						気に入った作品はリストから購入も可能。<br />
						あなた以外が購入した場合は、インセンティブをお支払いします。<br />
					</p>
				</div>

				<img className="w-44 md:w-44 h-44 md:h-44 object-cover mt-4 md:mt-4" alt="絵2" src="/images/shop1@2x.png" />
			</div>
			...
			<form onSubmit={handleSubmit}>
				...
				<div className="flex flex-col items-center justify-center h-full">
					<div className="flex flex-col items-center space-y-4 w-full max-w-2xl mt-4">
						...
						<button type="submit" className="w-full max-w-xl h-[58px] bg-#444 rounded-[var(--br-xs)] flex items-center justify-center text-lg  mt-2">
							登録/更新する
						</button>
					</div>
